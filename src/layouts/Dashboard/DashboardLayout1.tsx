    ...
    <div>
      <SidebarProvider>
        ...
        <SidebarInset className="bg-light-secondary-bg dark:bg-dark-secondary-bg">
          ...
          <div className="p-2 min-h-screen z-0">
            <div className="p-5 bg-slate-50 dark:bg-dark-primary-bg rounded-3xl shadow-inner shadow-slate-200 dark:shadow-black border-2 border-light-border dark:border-dark-border">
              <Outlet />
            </div>
          </div>
