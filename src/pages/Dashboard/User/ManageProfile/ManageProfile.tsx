            ...
            <div className="flex flex-col bs:flex-row gap-3 md:gap-5 mb-3 md:mb-5">
              <div className="flex flex-col gap-3 w-full bs:w-1/2">
                <div className="w-full items-center gap-3">
                  ...
                  <label
                    htmlFor="file_input"
                    className="cursor-pointer flex items-center justify-center px-4 py-2  text-slate-700 font-medium rounded-lg text-base transition-all duration-300 flex-1 w-full  border-[#dddcdc] border mt-1.5"
                  >
