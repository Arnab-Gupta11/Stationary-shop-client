        ...
        >
          {offers.map((item) => {
            ...
            return (
              <motion.div
                key={item.title}
                className="flex items-center justify-center gap-5 shadow-card-shadow-light rounded-3xl py-6 px-8 bg-light-secondary-bg dark:bg-dark-secondary-bg border-2 border-light-border dark:border-dark-border"
